...
class NoisyLinear(nn.Module):
    def __init__(self, in_features, out_features, std_init=0.4, noise_std=0.01):
    ...
    def reset_noise(self):
        self.noise_in.normal_(std=self.noise_std)
        self.noise_out_weight.normal_(std=self.noise_std)
        self.noise_out_bias.normal_(std=self.noise_std)
