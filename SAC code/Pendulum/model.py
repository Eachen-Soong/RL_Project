...
class SAC_Agent:
    def __init__(self):
        ...
        self.state_dim = 3  # example shape: [cos(theta), sin(theta), theta_dot]
        self.action_dim = 1  # example action: [torque] with range in [-2,2]
        self.lr_pi = 0.001  # learning rate for policy network
        self.lr_q = 0.001  # learning rate for Q-network
        self.gamma = 0.98  # discount factor for reward
        self.batch_size = 128  # size of the sampled mini-batch from the buffer
