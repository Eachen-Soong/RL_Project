...
parser.add_argument('--max_step', default=10000, type=int) # maximum num of steps
...
# hyperparams: tau, noise-std
directory = './exp' + script_name + args.env_name + f'/tau_{args.tau}_noise-std{args.exploration_noise}'
    ...
    if args.mode == 'test':
        ...
        for i in range(args.test_iteration):
            ...
            if args.record_tests:
                video_path = 'videos/PendulumDDPG_' +str(i)+'.mp4'
        ...
        for i in range(args.max_episode):
            ...
            for t in count():
                ...
                if args.render and i >= args.render_interval : env.render('rgb_array')
